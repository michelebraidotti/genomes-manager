...
public class RepeatsImporterTest {
	...
	public void initMocks() throws Exception {
		...
		gff3Content.add(seq.getId() +"\tagi_genomes_db	LTR_retrotransposon	60	62	.	-	.	ID=0;rclass=I;subclass=I;rorder=LTR;superfamily=test;family=test;notes=genreatedRepeat1;is_complete=true;ltr_5_length=4;ltr_3_length=3;pbs_x=61;pbs_y=61;ppt_x=61;ppt_y=61;rt_presence=true;rt_sequence=CCAATTGG;int_presence=true;int_sequence=AACCTTGG;ltr_comparison_similarity=8;ltr_comparison_nuc_distance=7;ltr_comparison_mutation_ca=3;ltr_comparison_mutation_ct=5;ltr_comparison_mutation_at=2;ltr_comparison_mutation_cg=4;ltr_comparison_insertion_time=5;tsd_sequence=GGAATTCC;gc_content_5=1;gc_content_3=1;rt_stop_codons_count=9;int_stop_codons_count=2;presence_in_sativa=PresenceInSativa1");
		gff3Content.add(seq.getId() +"\tagi_genomes_db	LTR_retrotransposon	47	58	.	-	.	ID=0;rclass=I;subclass=I;rorder=LTR;superfamily=test;family=test;notes=genreatedRepeat2;is_complete=true;ltr_5_length=5;ltr_3_length=4;pbs_x=48;pbs_y=57;ppt_x=48;ppt_y=57;rt_presence=true;rt_sequence=CCAATTGG;int_presence=true;int_sequence=AACCTTGG;ltr_comparison_similarity=9;ltr_comparison_nuc_distance=8;ltr_comparison_mutation_ca=4;ltr_comparison_mutation_ct=6;ltr_comparison_mutation_at=3;ltr_comparison_mutation_cg=5;ltr_comparison_insertion_time=6;tsd_sequence=GGAATTCC;gc_content_5=2;gc_content_3=2;rt_stop_codons_count=10;int_stop_codons_count=3;presence_in_sativa=PresenceInSativa2");
		...
		gff3Content.add(seq.getId() +"\tagi_genomes_db	helitron	21	40	.	+	.	ID=0;rclass=II;subclass=II;rorder=Helitron;superfamily=test;family=test;notes=genreatedRepeat0;orf_greater_than_50aa=1;is_potentially_autonomus=true;end_3=TT;end_5=GG");
		gff3Content.add(seq.getId() +"\tagi_genomes_db	helitron	54	55	.	-	.	ID=0;rclass=II;subclass=II;rorder=Helitron;superfamily=test;family=test;notes=genreatedRepeat1;potential_cds_count=1;orf_greater_than_50aa=2;is_potentially_autonomus=true;end_3=TT;end_5=GG");
		gff3Content.add(seq.getId() +"\tagi_genomes_db	helitron	36	47	.	-	.	ID=0;rclass=II;subclass=II;rorder=Helitron;superfamily=test;family=test;notes=genreatedRepeat2;potential_cds_count=2;orf_greater_than_50aa=3;is_potentially_autonomus=true;end_3=TT;end_5=GG");
		...
		gff3Content.add(seq.getId() +"\tagi_genomes_db	helitron	50	50	.	+	.	ID=0;rclass=II;subclass=II;rorder=Helitron;superfamily=test;family=test;notes=genreatedRepeat6;potential_cds_count=6;orf_greater_than_50aa=7;is_potentially_autonomus=true;end_3=TT;end_5=GG");
		gff3Content.add(seq.getId() +"\tagi_genomes_db	terminal_inverted_repeat_element	42	45	.	-	.	ID=0;rclass=II;subclass=I;rorder=DNA_TE;superfamily=test;family=test;notes=genreatedRepeat0;tir_x=43;tir_y=44;trans_presence=true;trans_sequence=AA;tsd_sequence=CC");
		gff3Content.add(seq.getId() +"\tagi_genomes_db	terminal_inverted_repeat_element	40	55	.	+	.	ID=0;rclass=II;subclass=I;rorder=DNA_TE;superfamily=test;family=test;notes=genreatedRepeat1;tir_x=41;tir_y=54;trans_presence=true;trans_sequence=AA;tsd_sequence=CC");
		...
		gff3Content.add(seq.getId() +"\tagi_genomes_db	terminal_inverted_repeat_element	63	63	.	-	.	ID=0;rclass=II;subclass=I;rorder=DNA_TE;superfamily=test;family=test;notes=genreatedRepeat6;tir_x=64;tir_y=62;trans_presence=true;trans_sequence=AA;tsd_sequence=CC");
	}
	...
	public void testImport() throws SequenceRepoException, RepeatRepoException, RepeatsImporterException, RepeatsClassificationException {
		...
		verify(repeatRepo).validatePosition((Repeat) anyObject());
