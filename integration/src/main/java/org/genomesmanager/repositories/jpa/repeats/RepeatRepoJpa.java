...
public class RepeatRepoJpa implements RepeatRepo {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.genomesmanager.repositories.jpa.repeats.RepeatRepo#delete(org.
	 ...
	 * 
	 * @see
	 * org.genomesmanager.repositories.jpa.repeats.RepeatRepo#deleteByKey(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.genomesmanager.repositories.jpa.repeats.RepeatRepo#getHelitron(int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.genomesmanager.repositories.jpa.repeats.RepeatRepo#getNew(org.
	 * genomesmanager.domain.entities.RepeatsClassification)
	 */
	@Override
	public Repeat getNew(RepeatsClassification repClass)
		...
		if (repOrder.equals(RepeatsOrder.LTR.getLabel())) {
			...
			throw new RepeatRepoException("Repeat order " + repOrder
					+ " not available");
		}
	 ...
	 * 
	 * @see
	 * org.genomesmanager.repositories.jpa.repeats.RepeatRepo#validatePosition
	 * (org.genomesmanager.domain.entities.Repeat)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.genomesmanager.repositories.jpa.repeats.RepeatRepo#validateUpdate
	 * (org.genomesmanager.domain.entities.Repeat)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.genomesmanager.repositories.jpa.repeats.RepeatRepo#countChildren(int)
	 */
	@SuppressWarnings("unchecked")
	@Override
	 ...
	 * 
	 * @see
	 * org.genomesmanager.repositories.jpa.repeats.RepeatRepo#getParent(int)
	 */
	@SuppressWarnings("unchecked")
	@Override
