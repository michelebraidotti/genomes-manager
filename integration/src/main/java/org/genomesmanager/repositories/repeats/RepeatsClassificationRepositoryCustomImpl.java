...
public class RepeatsClassificationRepositoryCustomImpl implements
	 ...
	 * 
	 * @see
	 * org.genomesmanager.services.impl.repeats.RepeatsClassificationExplorer
	 * #getAll()
	 */
	@Override
	...
	public List<String> getAllClassSubClassOrder() {
		...
		for (Object[] line : res) {
			...
			names.add(repClass + RepeatsClassification.SEPARATOR + subclass
					+ RepeatsClassification.SEPARATOR + order);
		}
		return names;
	}
	 ...
	 * @see
	 * org.genomesmanager.services.impl.repeats.RepeatsClassificationExplorer
	 * #getAllSuperfamilies(java.lang.String)
	 */
	@Override
	 ...
	 * @see
	 * org.genomesmanager.services.impl.repeats.RepeatsClassificationExplorer
	 * #getAllSuperfamilies(java.lang.String, java.lang.String,
	 * java.lang.String)
	 */
	@Override
	@SuppressWarnings("unchecked")
	 ...
	 * @see
	 * org.genomesmanager.services.impl.repeats.RepeatsClassificationExplorer
	 * #getAllFamilies(java.lang.String)
	 */
	@Override
	public List<String> getAllFamilies(String classifDefinition)
		...
		return getAllFamilies(definition[0], definition[1], definition[2],
				definition[3]);
	}
	 ...
	 * @see
	 * org.genomesmanager.services.impl.repeats.RepeatsClassificationExplorer
	 * #getAllFamilies(java.lang.String, java.lang.String, java.lang.String,
	 * java.lang.String)
	 */
	@Override
	@SuppressWarnings("unchecked")
	 ...
	 * @see
	 * org.genomesmanager.services.impl.repeats.RepeatsClassificationExplorer
	 * #getAllSubClasses(java.lang.String)
	 */
	@Override
	@SuppressWarnings("unchecked")
	 ...
	 * @see
	 * org.genomesmanager.services.impl.repeats.RepeatsClassificationExplorer
	 * #getAllOrders(java.lang.String, java.lang.String)
	 */
	@Override
	@SuppressWarnings("unchecked")
